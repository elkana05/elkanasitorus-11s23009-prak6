...
<head>
    ...
    @inertiaHead
    <!-- Trix editor (for rich text notes), SweetAlert2 and ApexCharts via CDN -->
    <!-- Use jsDelivr for Trix to avoid CDNJS 404/MIME issues -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/trix@2.0.0/dist/trix.min.css" />
    <script src="https://cdn.jsdelivr.net/npm/trix@2.0.0/dist/trix.min.js" defer></script>
